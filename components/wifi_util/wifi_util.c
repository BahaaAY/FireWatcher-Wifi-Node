                                             ...
                                             int security, const protocomm_security_pop_t *pop)
{
    ...
    ESP_LOGI(TAG, "Security %d, POP %s", security, pop ? "present" : "not present");
    ESP_LOGI(TAG, "Security %d, POP %s", g_prov->security, g_prov->pop ? "present" : "not present");

    ESP_LOGI(TAG, "Provisioning app started");
